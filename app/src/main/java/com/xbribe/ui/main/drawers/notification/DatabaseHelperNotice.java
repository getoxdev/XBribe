...
public class DatabaseHelperNotice extends SQLiteOpenHelper
{
   ...
   public DatabaseHelperNotice(Context context)
   {
    ...
    {
        db.execSQL("create table "+TABLE_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT,TOKEN TEXT,EMAILADDRESS  TEXT,MESSAGE TEXT,TITLE TEXT)");
    ...
    public boolean insertData(String token,String emailaddress,String message,String title)
    {
